...
const editorialBySku: Record<string, ProductEditorial> = {
  ...
  CJXFXJWR00039: {
    co: { title: "Dron plegable E58", seoTitle: "Dron plegable E58 con opciones de batería", metaDescription: "Dron E58 de cuerpo plegable. Compara las variantes y la cantidad de baterías indicada por el proveedor antes de elegir.", cardDescription: "Dron plegable con distintas opciones de batería.", detailDescription: "El proveedor identifica este modelo como E58 y describe una estructura de plástico. Las opciones 1080P 1, 1080P 2 y 1080P 3 corresponden a una, dos y tres baterías, respectivamente.", benefits: ["Permite elegir la cantidad de baterías"], features: ["Modelo E58", "Cuerpo de plástico"], warnings: ["Confirma la variante antes de pagar", "Lee el manual y las restricciones locales de vuelo"] },
    us: { title: "E58 Folding Drone", seoTitle: "E58 folding drone with battery options", metaDescription: "E58 folding drone with selectable battery bundles. Review the supplier variant and the number of included batteries before ordering.", cardDescription: "A folding drone with selectable battery bundles.", detailDescription: "The supplier identifies this model as E58 with a plastic body. The 1080P 1, 1080P 2 and 1080P 3 options indicate one, two and three batteries respectively.", benefits: ["Choice of battery bundles"], features: ["E58 model", "Plastic body"], warnings: ["Confirm your selected variant before paying", "Read the manual and local flight restrictions"] },
  },
  CJJT1204038: {
    co: { title: "Kit de palanca y rodillos para muebles", seoTitle: "Kit para mover muebles con palanca y cuatro apoyos", metaDescription: "Kit con una palanca y cuatro apoyos con rodillos para reorganizar muebles. Revisa dimensiones y condiciones de uso del proveedor.", cardDescription: "Una palanca y cuatro apoyos con rodillos para mover muebles.", detailDescription: "La ficha incluye una palanca de 345 mm y cuatro apoyos con rodillos. El proveedor menciona acero y plásticos ABS, PS y PVC; las cifras de carga de su descripción son inconsistentes y deben confirmarse antes de usarlo.", benefits: ["Reúne palanca y apoyos en un kit"], features: ["Una palanca", "Cuatro apoyos con rodillos"], warnings: ["Confirma la capacidad de carga con el proveedor", "Verifica la estabilidad del mueble y la superficie"] },
    us: { title: "Furniture Lifter and Roller Kit", seoTitle: "Furniture lifter with four roller supports", metaDescription: "Furniture moving kit with a lever and four roller supports. Review supplier dimensions and usage conditions before ordering.", cardDescription: "A lever and four roller supports for repositioning furniture.", detailDescription: "The supplier lists a 345 mm lever and four roller supports made with steel and ABS, PS and PVC plastics. Load figures in the source description conflict and require confirmation before use.", benefits: ["Lever and supports in one kit"], features: ["One lever", "Four roller supports"], warnings: ["Confirm load capacity with the supplier", "Check furniture stability and the floor surface"] },
  },
  CJZS1305006: {
    co: { title: "Dispositivo eléctrico de depilación", seoTitle: "Dispositivo de depilación con adaptador", metaDescription: "Dispositivo eléctrico de depilación en ABS con adaptador y manual según la ficha. Verifica compatibilidad y variante antes de comprar.", cardDescription: "Dispositivo de depilación con adaptador y manual.", detailDescription: "La ficha del proveedor describe un dispositivo de depilación con carcasa ABS y alimentación eléctrica, disponible con distintas opciones de enchufe. El paquete informado incluye dispositivo, afeitadora, adaptador y manual.", benefits: ["Opciones de enchufe según variante"], features: ["Carcasa ABS", "Adaptador y manual informados por el proveedor"], warnings: ["Confirma compatibilidad, instrucciones y contraindicaciones del fabricante", "La ficha indica que no se lava con agua", "No se garantizan resultados de depilación"] },
    us: { title: "Electric Hair Removal Device", seoTitle: "Hair removal device with power adapter", metaDescription: "Electric hair removal device with an ABS body and adapter. Check the plug option, compatibility and manufacturer instructions.", cardDescription: "Hair removal device with an adapter and manual.", detailDescription: "The supplier describes an electrically powered hair removal device with an ABS body and multiple plug options. The listed package includes the device, shaver, adapter and manual.", benefits: ["Selectable plug options"], features: ["ABS body", "Supplier lists adapter and manual"], warnings: ["Check manufacturer compatibility, instructions and contraindications", "The supplier specifies no water washing", "Hair removal results are not guaranteed"] },
  },
  CJBJMRDD00038: {
    co: { title: "Masajeador facial eléctrico compacto", seoTitle: "Masajeador facial con cable USB", metaDescription: "Masajeador facial compacto con carcasa ABS y aleación de zinc. Consulta accesorios, instrucciones y disponibilidad de la variante.", cardDescription: "Formato compacto con cable USB y bolsa de tela.", detailDescription: "El proveedor informa un dispositivo de 10,6 × 6,5 cm en ABS y aleación de zinc. El paquete incluye instrumento, cable USB, bolsa de tela e instrucciones. Nexora no atribuye resultados clínicos a este producto.", benefits: ["Formato compacto para guardar"], features: ["ABS y aleación de zinc", "Cable USB y bolsa de tela"], warnings: ["Revisa las instrucciones y contraindicaciones del fabricante", "No sustituye atención ni tratamientos profesionales"] },
    us: { title: "Compact Electric Facial Massager", seoTitle: "Compact facial massager with USB cable", metaDescription: "Compact facial massager with an ABS and zinc alloy body. Review the selected variant, accessories and manufacturer instructions.", cardDescription: "Compact format with a USB cable and fabric bag.", detailDescription: "The supplier lists a 10.6 × 6.5 cm device made of ABS and zinc alloy. The package includes the device, USB cable, fabric bag and instructions. Nexora makes no clinical outcome claims for this product.", benefits: ["Compact format for storage"], features: ["ABS and zinc alloy", "USB cable and fabric bag"], warnings: ["Read manufacturer instructions and contraindications", "Does not replace professional care or treatment"] },
  },
  CJBJMRPF00001: {
    co: { title: "Accesorio de resistencia para mentón", seoTitle: "Accesorio compacto con resortes intercambiables", metaDescription: "Accesorio manual de ABS y TPR con resortes intercambiables y bolsa. Revisa las instrucciones del fabricante antes de usarlo.", cardDescription: "Accesorio manual compacto con resortes intercambiables.", detailDescription: "La ficha informa un accesorio de ABS y TPR de 140 × 60 × 52 mm. El contenido declarado incluye tres resortes, instrucciones y bolsa. No se prometen cambios estéticos ni resultados terapéuticos.", benefits: ["Resortes intercambiables", "Bolsa para guardarlo"], features: ["ABS y TPR", "Tres resortes según contenido del paquete"], warnings: ["Sigue las instrucciones del fabricante", "No se garantizan cambios estéticos"] },
    us: { title: "Compact Chin Resistance Accessory", seoTitle: "Manual accessory with interchangeable springs", metaDescription: "Compact ABS and TPR manual accessory with interchangeable springs and a bag. Read manufacturer instructions before use.", cardDescription: "A compact manual accessory with interchangeable springs.", detailDescription: "The supplier lists an ABS and TPR accessory measuring 140 × 60 × 52 mm. The declared package includes three springs, instructions and a bag. No cosmetic changes or therapeutic outcomes are promised.", benefits: ["Interchangeable springs", "Storage bag"], features: ["ABS and TPR", "Three springs in the package listing"], warnings: ["Follow manufacturer instructions", "Cosmetic changes are not guaranteed"] },
  },
  CJLX1237838: {
    co: {
