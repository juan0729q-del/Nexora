...
export const niches = {
  jewelry: { id: "jewelry", label: "Joyería", menuLabel: "Joyería", description: "Piezas de acero y detalles que elevan tu estilo.", supplierQuery: "jewelry" },
  technologyHome: { id: "technologyHome", label: "Tecnología y hogar", menuLabel: "Tecnología/Hogar", description: "Tecnología funcional para un espacio mejor resuelto.", supplierQuery: "home electronics" },
  wellbeing: { id: "wellbeing", label: "Bienestar", menuLabel: "Bienestar", description: "Herramientas para cuidar tu energía y tu rutina.", supplierQuery: "health wellness" },
} as const;
...
export type Product = {
  slug: string; name: string; category: string; niche: ProductNiche; description: string; longDescription: string;
  image: { src: string; alt: string; source?: "provider" | "fallback" }; price: number; compareAtPrice?: number; rating: number;
...
/** Fuente única de tienda, checkout, detalle y dashboard hasta conectar una base de datos. */
const catalog: readonly Product[] = [
  {
    slug: "set-joyeria-acero-titanio", name: "Set de joyería Acero Titanio", category: "Moda masculina", niche: "jewelry", description: "Cadena y pulsera con presencia sobria para todos los días.", longDescription: "Un set de joyería de acero titanio diseñado para completar un look masculino con una silueta limpia, resistente y fácil de combinar.", image: { src: "/products/joyeria-acero-titanio.png", alt: "Set de cadena y pulsera de acero titanio sobre una base negra", source: "fallback" }, price: 129900, compareAtPrice: 159900, rating: 4.8, reviewCount: 126, stock: 14, active: true, sku: "NX-JOY-001", material: "Acero titanio", accent: "silver", supplier: { name: "CJ Dropshipping", sourcePage: "Catálogo de joyería", sourceUrl: "https://cjdropshipping.com/", reference: "CJ-NX-JOY-001" }, performance: { salesLast30Days: 34, conversionRate: 5.4, returnRate: 1.2 },
  },
  {
    slug: "cadena-eslabones-titanio", name: "Cadena de eslabones Titanio", category: "Moda masculina", niche: "jewelry", description: "Una cadena de perfil limpio para elevar combinaciones diarias.", longDescription: "Cadena de acero titanio con acabado pulido y una construcción creada para uso frecuente.", image: { src: "/products/joyeria-acero-titanio.png", alt: "Cadena de eslabones de acero titanio sobre una base negra", source: "fallback" }, price: 89900, rating: 4.6, reviewCount: 41, stock: 21, active: true, sku: "NX-JOY-004", material: "Acero titanio", accent: "silver", supplier: { name: "CJ Dropshipping", sourcePage: "Catálogo de joyería", sourceUrl: "https://cjdropshipping.com/", reference: "CJ-NX-JOY-004" }, performance: { salesLast30Days: 18, conversionRate: 4.3, returnRate: 1.4 },
  },
  {
    slug: "estacion-carga-eco-bamboo", name: "Estación de carga Eco-Bamboo", category: "Tecnología", niche: "technologyHome", description: "Ordena tu escritorio y carga tus dispositivos en un solo lugar.", longDescription: "La estación de carga Eco-Bamboo combina organización y tecnología para mantener teléfono, reloj y accesorios al alcance, con una presencia cálida sobre tu escritorio.", image: { src: "/products/estacion-carga-eco-bamboo.png", alt: "Estación de carga de bambú para teléfono, reloj y audífonos", source: "fallback" }, price: 189900, rating: 4.9, reviewCount: 84, stock: 8, active: true, sku: "NX-TEC-002", material: "Bambú certificado", accent: "warm", supplier: { name: "CJ Dropshipping", sourcePage: "Catálogo de hogar y electrónica", sourceUrl: "https://cjdropshipping.com/", reference: "CJ-NX-TEC-002" }, performance: { salesLast30Days: 29, conversionRate: 5.1, returnRate: 0.8 },
  },
  {
    slug: "soporte-carga-bamboo-mini", name: "Soporte de carga Bamboo Mini", category: "Tecnología", niche: "technologyHome", description: "Base compacta para conservar orden y energía en tu espacio.", longDescription: "Un soporte de escritorio en bambú pensado para mantener el teléfono visible mientras se carga.", image: { src: "/products/estacion-carga-eco-bamboo.png", alt: "Soporte de carga compacto de bambú para escritorio", source: "fallback" }, price: 99900, rating: 4.5, reviewCount: 36, stock: 17, active: true, sku: "NX-TEC-005", material: "Bambú certificado", accent: "warm", supplier: { name: "CJ Dropshipping", sourcePage: "Catálogo de hogar y electrónica", sourceUrl: "https://cjdropshipping.com/", reference: "CJ-NX-TEC-005" }, performance: { salesLast30Days: 16, conversionRate: 4.1, returnRate: 1.1 },
  },
  {
    slug: "corrector-postura-inteligente", name: "Corrector de postura inteligente", category: "Bienestar", niche: "wellbeing", description: "Una señal suave para volver a una postura más consciente.", longDescription: "Un corrector de postura inteligente que acompaña tus jornadas de trabajo y movimiento con recordatorios discretos para construir mejores hábitos corporales.", image: { src: "/products/corrector-postura-inteligente.png", alt: "Corrector de postura inteligente negro con correa ajustable", source: "fallback" }, price: 149900, compareAtPrice: 179900, rating: 4.7, reviewCount: 63, stock: 3, active: true, sku: "NX-BIE-003", material: "Sensor háptico", accent: "emerald", supplier: { name: "CJ Dropshipping", sourcePage: "Catálogo de bienestar", sourceUrl: "https://cjdropshipping.com/", reference: "CJ-NX-BIE-003" }, performance: { salesLast30Days: 22, conversionRate: 4.6, returnRate: 1.8 },
  },
  {
    slug: "corrector-postura-active", name: "Corrector de postura Active", category: "Bienestar", niche: "wellbeing", description: "Soporte ajustable para jornadas largas y movimiento cotidiano.", longDescription: "Corrector de postura con bandas ajustables, ideado para acompañar una rutina de movilidad consciente.", image: { src: "/products/corrector-postura-inteligente.png", alt: "Corrector de postura Active negro con bandas ajustables", source: "fallback" }, price: 119900, rating: 4.2, reviewCount: 12, stock: 11, active: true, sku: "NX-BIE-006", material: "Tejido técnico ajustable", accent: "emerald", supplier: { name: "CJ Dropshipping", sourcePage: "Catálogo de bienestar", sourceUrl: "https://cjdropshipping.com/", reference: "CJ-NX-BIE-006" }, performance: { salesLast30Days: 3, conversionRate: 0.7, returnRate: 8.2 },
  },
];
...
export function getStoreCatalog(niche?: ProductNiche) { return catalog.filter((product) => product.active && getCatalogDecision(product) !== "pause" && (!niche || product.niche === niche)); }
